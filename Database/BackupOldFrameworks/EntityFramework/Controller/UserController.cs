...
using UserTable = TexasHoldem.Database.BackupOldFrameworks.EntityFramework.Model.UserTable;
...
namespace TexasHoldem.Database.EntityFramework.Controller
{
    public class UserController 
    {
        ...
        public void AddNewUser(BackupOldFrameworks.EntityFramework.Model.UserTable objUser)
        {
            try
            {
                using (var context = new DataBaseSadnaEntitiesNewest())
                {
                        ...
                        var ob = new BackupOldFrameworks.EntityFramework.Model.UserTable
                    {
